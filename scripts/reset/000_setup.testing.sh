...
# Recreate default for testing environment.
...
cp $ROOT_DIR/root/conf/drupal/testing/default.settings.php $ROOT_DIR/sites/default/settings.php
chmod 664 $ROOT_DIR/sites/default/settings.php

# Create sync config directory.
if [ -d $ROOT_DIR/sites/default/files/config/sync ]; then
  mkdir -p $ROOT_DIR/sites/default/files/config/sync
fi

# Symlink settings.php
#ln -s $ROOT_DIR/root/conf/drupal/testing/settings.php $ROOT_DIR/sites/default/settings.php
