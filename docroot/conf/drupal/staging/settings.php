 ...
 */
$databases['default']['default'] = array (
  'database' => 'wik_website',
  'username' => 'wik_website',
  'password' => 'zYd6U3JZwjD6rg',
  'prefix' => '',
  'host' => 'localhost',
  'port' => '3306',
 ...
 */
$config_directories = array(
  'main' => 'profiles/wirimkiez_profile/config/main',
  'sync' => 'sites/default/files/config/sync',
);
 ...
 * @endcode
 */
#$settings['hash_salt'] = file_get_contents(rtrim(getenv('HOME'), '/') . '/secure/salt.txt');
$settings['hash_salt'] = 'AC2PoTcdVl/8KdG6/VAWTPD+vd2HRxBIIuCawi9Jp1aO4eLZQAeq1K6l5zziG8ZS n2HutqySeqNVedE9L/NiKw==';
...
# }
$settings['install_profile'] = 'wirimkiez_profile';
$settings['container_yamls'][] = __DIR__ . '/services.yml';

$config_directories['active'] = 'sites/default/files/config_LmCZ51VMePxjaTZ9fKNH_5Pk8yDmEIV_UFGd-7mKaI15SSXqLLsD2B4Wi0T85-y8R1U1PPhTlg/active';
$config_directories['staging'] = 'sites/default/files/config_LmCZ51VMePxjaTZ9fKNH_5Pk8yDmEIV_UFGd-7mKaI15SSXqLLsD2B4Wi0T85-y8R1U1PPhTlg/staging';

#if (file_exists(DRUPAL_ROOT . '/sites/default/settings.local.php')) {
#  include DRUPAL_ROOT . '/sites/default/settings.local.php';
#}

$settings['dfki_classify_service_uri'] = 'https://esttest.dfki.de/http/wik/wik-server/classify/';

/**
 * Enable push notifications.
 */
$settings['wik_push_notifications_enabled'] = TRUE;

/**
 * Push notifications sockets configuration. Define where are localted the webservices used for the push notifications. The webservices are the following:

 * - zmq_sochet : The webservice used as a queue for storing the messages generated at the backend side.
 *                This parameter is used at : modules/custom/wik_userprofile/wik_userprofile.module line 96.
 * - client_subscribe_socket: This webservices is used for subscribing the users to the push notifications. This is used at : modules/custom/wik_channel/js/ws.js line 3.
 */

$settings['push_notifications_websockets'] = array(
  'zmq_socket' => array(
    'host' => '127.0.0.1',
    'port' => '5555',
  ),
  'client_subscribe_socket' => array(
    'host' => 'wik-staging.cocomore.com',
    'port' => '8383',
  ),
);
